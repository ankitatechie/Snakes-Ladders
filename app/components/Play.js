...
class PlayGame extends React.Component {
    ...
    updatePlayerPosition(diceNumber) {
        const _currentPlayer = this.props.players[this.state.activePlayer];
        const _snakes = this.snakes;
        const _ladders = this.ladders;
        const maxNumber = this.props.maxNumber;
        const currentPosition = _currentPlayer.position;
        const nextPosition = _currentPlayer.position + diceNumber;
    ...
    render() {
        ...
        const activePlayer = this.props.players[state.activePlayer].name;
        return (
...
PlayGame.propTypes = {
    ...
    changeGameStatus: PropTypes.function
};
